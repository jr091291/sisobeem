...
import static sisobeem.websocket.Session.DeviceSessionHandler10.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler10;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex10")
public class JadexWebSocketServer10{
       
	 
	 private DeviceSessionHandler10 sessionHandler = getDeviceSessionHandler();
