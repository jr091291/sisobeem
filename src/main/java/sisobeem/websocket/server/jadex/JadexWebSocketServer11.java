...
import static sisobeem.websocket.Session.DeviceSessionHandler11.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler11;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex11")
public class JadexWebSocketServer11{
       
	 
	 private DeviceSessionHandler11 sessionHandler = getDeviceSessionHandler();
