...
import static sisobeem.websocket.Session.DeviceSessionHandler12.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler12;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex12")
public class JadexWebSocketServer12{
       
	 
	 private DeviceSessionHandler12 sessionHandler = getDeviceSessionHandler();
