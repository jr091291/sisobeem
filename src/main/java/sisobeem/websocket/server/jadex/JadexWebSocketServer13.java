...
import static sisobeem.websocket.Session.DeviceSessionHandler13.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler13;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex13")
public class JadexWebSocketServer13{
       
	 
	 private DeviceSessionHandler13 sessionHandler = getDeviceSessionHandler();
