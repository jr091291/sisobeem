...
import static sisobeem.websocket.Session.DeviceSessionHandler14.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler14;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex14")
public class JadexWebSocketServer14{
       
	 
	 private DeviceSessionHandler14 sessionHandler = getDeviceSessionHandler();
