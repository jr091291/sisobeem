...
import static sisobeem.websocket.Session.DeviceSessionHandler15.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler15;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex15")
public class JadexWebSocketServer15{
       
	 
	 private DeviceSessionHandler15 sessionHandler = getDeviceSessionHandler();
