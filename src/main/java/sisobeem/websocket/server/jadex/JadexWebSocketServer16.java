...
import static sisobeem.websocket.Session.DeviceSessionHandler16.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler16;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex16")
public class JadexWebSocketServer16{
       
	 
	 private DeviceSessionHandler16 sessionHandler = getDeviceSessionHandler();
