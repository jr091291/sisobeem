...
import static sisobeem.websocket.Session.DeviceSessionHandler17.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler17;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex17")
public class JadexWebSocketServer17{
       
	 
	 private DeviceSessionHandler17 sessionHandler = getDeviceSessionHandler();
