...
import static sisobeem.websocket.Session.DeviceSessionHandler18.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler18;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex18")
public class JadexWebSocketServer18{
       
	 
	 private DeviceSessionHandler18 sessionHandler = getDeviceSessionHandler();
