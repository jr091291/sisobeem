...
import static sisobeem.websocket.Session.DeviceSessionHandler19.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler19;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex19")
public class JadexWebSocketServer19{
       
	 
	 private DeviceSessionHandler19 sessionHandler = getDeviceSessionHandler();
