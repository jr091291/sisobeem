...
import static sisobeem.websocket.Session.DeviceSessionHandler2.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler2;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex2")
public class JadexWebSocketServer2 {
 
	 private DeviceSessionHandler2 sessionHandler = getDeviceSessionHandler();
