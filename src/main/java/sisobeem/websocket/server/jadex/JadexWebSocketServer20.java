...
import static sisobeem.websocket.Session.DeviceSessionHandler20.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler20;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex20")
public class JadexWebSocketServer20{
       
	 
	 private DeviceSessionHandler20 sessionHandler = getDeviceSessionHandler();
