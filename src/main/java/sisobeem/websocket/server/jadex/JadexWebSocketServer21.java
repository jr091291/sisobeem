...
import static sisobeem.websocket.Session.DeviceSessionHandler21.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler21;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex21")
public class JadexWebSocketServer21{
       
	 
	 private DeviceSessionHandler21 sessionHandler = getDeviceSessionHandler();
