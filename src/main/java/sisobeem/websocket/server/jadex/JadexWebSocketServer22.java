...
import static sisobeem.websocket.Session.DeviceSessionHandler22.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler22;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex22")
public class JadexWebSocketServer22{
       
	 
	 private DeviceSessionHandler22 sessionHandler = getDeviceSessionHandler();
