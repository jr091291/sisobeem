...
import static sisobeem.websocket.Session.DeviceSessionHandler23.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler23;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex23")
public class JadexWebSocketServer23{
       
	 
	 private DeviceSessionHandler23 sessionHandler = getDeviceSessionHandler();
