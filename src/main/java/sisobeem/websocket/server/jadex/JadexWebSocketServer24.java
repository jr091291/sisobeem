...
import static sisobeem.websocket.Session.DeviceSessionHandler24.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler24;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex24")
public class JadexWebSocketServer24{
       
	 
	 private DeviceSessionHandler24 sessionHandler = getDeviceSessionHandler();
