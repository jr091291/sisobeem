...
import static sisobeem.websocket.Session.DeviceSessionHandler25.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler25;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex25")
public class JadexWebSocketServer25{
       
	 
	 private DeviceSessionHandler25 sessionHandler = getDeviceSessionHandler();
