...
import static sisobeem.websocket.Session.DeviceSessionHandler26.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler26;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex26")
public class JadexWebSocketServer26{
       
	 
	 private DeviceSessionHandler26 sessionHandler = getDeviceSessionHandler();
