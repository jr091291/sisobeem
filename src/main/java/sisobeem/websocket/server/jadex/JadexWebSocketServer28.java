...
import static sisobeem.websocket.Session.DeviceSessionHandler28.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler28;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex28")
public class JadexWebSocketServer28{
       
	 
	 private DeviceSessionHandler28 sessionHandler = getDeviceSessionHandler();
