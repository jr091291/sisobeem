...
import static sisobeem.websocket.Session.DeviceSessionHandler29.getDeviceSessionHandler;
...
@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex29")
public class JadexWebSocketServer29{
       
	 
	 private DeviceSessionHandler29 sessionHandler = getDeviceSessionHandler();
