...
import static sisobeem.websocket.Session.DeviceSessionHandler30.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler30;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex30")
public class JadexWebSocketServer30{
       
	 
	 private DeviceSessionHandler30 sessionHandler = getDeviceSessionHandler();
