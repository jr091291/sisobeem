...
import static sisobeem.websocket.Session.DeviceSessionHandler31.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler31;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex31")
public class JadexWebSocketServer31{
       
	 
	 private DeviceSessionHandler31 sessionHandler = getDeviceSessionHandler();
