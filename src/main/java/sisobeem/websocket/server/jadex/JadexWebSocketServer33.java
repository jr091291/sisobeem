...
import static sisobeem.websocket.Session.DeviceSessionHandler33.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler33;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex33")
public class JadexWebSocketServer33{
       
	 
	 private DeviceSessionHandler33 sessionHandler = getDeviceSessionHandler();
