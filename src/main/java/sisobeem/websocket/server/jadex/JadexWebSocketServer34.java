...
import static sisobeem.websocket.Session.DeviceSessionHandler34.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler34;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex34")
public class JadexWebSocketServer34{
       
	 
	 private DeviceSessionHandler34 sessionHandler = getDeviceSessionHandler();
