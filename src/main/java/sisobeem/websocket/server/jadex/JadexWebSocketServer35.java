...
import static sisobeem.websocket.Session.DeviceSessionHandler35.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler35;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex35")
public class JadexWebSocketServer35{
       
	 
	 private DeviceSessionHandler35 sessionHandler = getDeviceSessionHandler();
