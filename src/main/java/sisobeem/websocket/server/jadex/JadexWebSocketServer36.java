...
import static sisobeem.websocket.Session.DeviceSessionHandler36.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler36;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex36")
public class JadexWebSocketServer36{
       
	 
	 private DeviceSessionHandler36 sessionHandler = getDeviceSessionHandler();
