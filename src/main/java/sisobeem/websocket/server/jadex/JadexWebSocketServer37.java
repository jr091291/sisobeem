...
import static sisobeem.websocket.Session.DeviceSessionHandler37.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler37;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex37")
public class JadexWebSocketServer37{
       
	 
	 private DeviceSessionHandler37 sessionHandler = getDeviceSessionHandler();
