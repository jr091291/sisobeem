...
import static sisobeem.websocket.Session.DeviceSessionHandler38.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler38;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex38")
public class JadexWebSocketServer38{
       
	 
	 private DeviceSessionHandler38 sessionHandler = getDeviceSessionHandler();
