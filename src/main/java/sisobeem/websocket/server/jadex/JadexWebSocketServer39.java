...
import static sisobeem.websocket.Session.DeviceSessionHandler39.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler39;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex39")
public class JadexWebSocketServer39{
       
	 
	 private DeviceSessionHandler39 sessionHandler = getDeviceSessionHandler();
