...
import static sisobeem.websocket.Session.DeviceSessionHandler40.getDeviceSessionHandler;
...
@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex40")
public class JadexWebSocketServer40{
       
	 
	 private DeviceSessionHandler40 sessionHandler = getDeviceSessionHandler();
