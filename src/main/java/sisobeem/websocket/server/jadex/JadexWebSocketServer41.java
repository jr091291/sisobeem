...
import static sisobeem.websocket.Session.DeviceSessionHandler41.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler41;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex41")
public class JadexWebSocketServer41{
       
	 
	 private DeviceSessionHandler41 sessionHandler = getDeviceSessionHandler();
