...
import static sisobeem.websocket.Session.DeviceSessionHandler42.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler42;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex42")
public class JadexWebSocketServer42{
       
	 
	 private DeviceSessionHandler42 sessionHandler = getDeviceSessionHandler();
