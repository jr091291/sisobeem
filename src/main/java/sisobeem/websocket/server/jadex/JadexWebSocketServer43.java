...
import static sisobeem.websocket.Session.DeviceSessionHandler43.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler43;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex43")
public class JadexWebSocketServer43{
       
	 
	 private DeviceSessionHandler43 sessionHandler = getDeviceSessionHandler();
