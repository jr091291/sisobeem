...
import static sisobeem.websocket.Session.DeviceSessionHandler44.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler40;
import sisobeem.websocket.Session.DeviceSessionHandler44;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex44")
public class JadexWebSocketServer44{
       
	 
	 private DeviceSessionHandler44 sessionHandler = getDeviceSessionHandler();
