...
import static sisobeem.websocket.Session.DeviceSessionHandler45.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler45;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex45")
public class JadexWebSocketServer45{
       
	 
	 private DeviceSessionHandler45 sessionHandler = getDeviceSessionHandler();
