...
import static sisobeem.websocket.Session.DeviceSessionHandler46.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler46;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex46")
public class JadexWebSocketServer46{
       
	 
	 private DeviceSessionHandler46 sessionHandler = getDeviceSessionHandler();
