...
import static sisobeem.websocket.Session.DeviceSessionHandler47.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler47;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex47")
public class JadexWebSocketServer47{
       
	 
	 private DeviceSessionHandler47 sessionHandler = getDeviceSessionHandler();
