...
import static sisobeem.websocket.Session.DeviceSessionHandler48.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler48;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex48")
public class JadexWebSocketServer48{
       
	 
	 private DeviceSessionHandler48 sessionHandler = getDeviceSessionHandler();
