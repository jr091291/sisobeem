...
import static sisobeem.websocket.Session.DeviceSessionHandler49.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler49;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex49")
public class JadexWebSocketServer49{
       
	 
	 private DeviceSessionHandler49 sessionHandler = getDeviceSessionHandler();
