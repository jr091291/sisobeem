...
import static sisobeem.websocket.Session.DeviceSessionHandler5.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler5;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex5")
public class JadexWebSocketServer5{
       
	 
	 private DeviceSessionHandler5 sessionHandler = getDeviceSessionHandler();
