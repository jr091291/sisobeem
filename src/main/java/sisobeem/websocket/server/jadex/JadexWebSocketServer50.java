...
import static sisobeem.websocket.Session.DeviceSessionHandler50.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler50;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex50")
public class JadexWebSocketServer50{
       
	 
	 private DeviceSessionHandler50 sessionHandler = getDeviceSessionHandler();
