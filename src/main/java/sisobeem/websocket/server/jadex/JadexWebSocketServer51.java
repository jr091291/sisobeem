...
import static sisobeem.websocket.Session.DeviceSessionHandler51.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler51;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex51")
public class JadexWebSocketServer51{
       
	 
	 private DeviceSessionHandler51 sessionHandler = getDeviceSessionHandler();
