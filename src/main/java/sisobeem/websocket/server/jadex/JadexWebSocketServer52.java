...
import static sisobeem.websocket.Session.DeviceSessionHandler52.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler52;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex52")
public class JadexWebSocketServer52{
       
	 
	 private DeviceSessionHandler52 sessionHandler = getDeviceSessionHandler();
