...
import static sisobeem.websocket.Session.DeviceSessionHandler53.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler53;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex53")
public class JadexWebSocketServer53{
       
	 
	 private DeviceSessionHandler53 sessionHandler = getDeviceSessionHandler();
