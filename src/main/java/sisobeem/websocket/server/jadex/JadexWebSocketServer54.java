...
import static sisobeem.websocket.Session.DeviceSessionHandler54.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler54;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex54")
public class JadexWebSocketServer54{
       
	 
	 private DeviceSessionHandler54 sessionHandler = getDeviceSessionHandler();
