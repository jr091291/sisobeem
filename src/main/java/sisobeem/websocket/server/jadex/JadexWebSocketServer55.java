...
import static sisobeem.websocket.Session.DeviceSessionHandler55.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler55;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex55")
public class JadexWebSocketServer55{
       
	 
	 private DeviceSessionHandler55 sessionHandler = getDeviceSessionHandler();
