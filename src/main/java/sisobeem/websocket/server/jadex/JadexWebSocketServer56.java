...
import static sisobeem.websocket.Session.DeviceSessionHandler56.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler56;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex56")
public class JadexWebSocketServer56{
       
	 
	 private DeviceSessionHandler56 sessionHandler = getDeviceSessionHandler();
