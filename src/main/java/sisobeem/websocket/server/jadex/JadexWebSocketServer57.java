...
import static sisobeem.websocket.Session.DeviceSessionHandler57.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler57;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex57")
public class JadexWebSocketServer57{
       
	 
	 private DeviceSessionHandler57 sessionHandler = getDeviceSessionHandler();
