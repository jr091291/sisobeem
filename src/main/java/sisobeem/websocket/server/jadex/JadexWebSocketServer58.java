...
import static sisobeem.websocket.Session.DeviceSessionHandler58.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler58;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex58")
public class JadexWebSocketServer58{
       
	 
	 private DeviceSessionHandler58 sessionHandler = getDeviceSessionHandler();
