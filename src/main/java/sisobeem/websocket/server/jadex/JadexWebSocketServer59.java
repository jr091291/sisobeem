...
import static sisobeem.websocket.Session.DeviceSessionHandler59.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler59;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex59")
public class JadexWebSocketServer59{
       
	 
	 private DeviceSessionHandler59 sessionHandler = getDeviceSessionHandler();
