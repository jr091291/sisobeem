...
import static sisobeem.websocket.Session.DeviceSessionHandler6.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler6;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex6")
public class JadexWebSocketServer6{
       
	 
	 private DeviceSessionHandler6 sessionHandler = getDeviceSessionHandler();
