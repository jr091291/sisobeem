...
import static sisobeem.websocket.Session.DeviceSessionHandler60.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler60;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex60")
public class JadexWebSocketServer60{
       
	 
	 private DeviceSessionHandler60 sessionHandler = getDeviceSessionHandler();
