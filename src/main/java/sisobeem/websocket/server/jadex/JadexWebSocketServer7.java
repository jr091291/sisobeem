...
import static sisobeem.websocket.Session.DeviceSessionHandler7.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler7;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex7")
public class JadexWebSocketServer7{
       
	 
	 private DeviceSessionHandler7 sessionHandler = getDeviceSessionHandler();
