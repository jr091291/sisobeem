...
import static sisobeem.websocket.Session.DeviceSessionHandler8.getDeviceSessionHandler;
...
import sisobeem.websocket.Session.DeviceSessionHandler8;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex8")
public class JadexWebSocketServer8{
       
	 
	 private DeviceSessionHandler8 sessionHandler = getDeviceSessionHandler();
