...
import sisobeem.websocket.Session.DeviceSessionHandler9;
import static sisobeem.websocket.Session.DeviceSessionHandler9.getDeviceSessionHandler;

@ApplicationScoped
@ServerEndpoint(value="/simulacion/jadex9")
public class JadexWebSocketServer9{
       
	 
	 private DeviceSessionHandler9 sessionHandler = getDeviceSessionHandler();
